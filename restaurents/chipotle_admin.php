    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <hr>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> Chipotle</p>
...
$sql = "SELECT id, name, res_name, method, total_products, total_price FROM `order` WHERE res_name = 'chipotle'";
