...
<header class="bgimg w3-display-container w3-grayscale-min" id="home">
  ...
  <div class="w3-display-bottomleft w3-center">
    <span style="background-color: black; padding: 10px; font-size: 90px; font-weight: bold;" class="w3-text-white">Burger King</span>
  </div>
...
$sql = "SELECT id, item, price FROM burgerking";
